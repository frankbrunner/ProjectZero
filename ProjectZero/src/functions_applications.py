...
class pz_Applications(db_functions):
    ...
    def createApplication(self, ApplicationName):
        ...
        #2 any Failure
        rows = [self.structApplications.name]
        values = [str(ApplicationName)]
        select = self.structApplications.name
    ...
    def getApplication(self, Application_id=None):
        ...
        rows=self.structApplications.rows
    ...
    def getApplicatioID(self, ApplicationName):
        ...
        if ApplicationName != None:
            conditions = [self.structApplications.name]
 ...
 #Unit Test Section
app = pz_Applications("dbuser", "34df!5awe", "ProjectZero")

...
class Resolver(object):
    ...
    def _resolve_one(self, requirement_set, req_to_install):
        ...
        def add_req(subreq, extras_requested):
            ...
            parent_req_name = req_to_install.release
        ...
        with indent_log():
            ...
            if not requirement_set.has_requirement(req_to_install.release):
    ...
    def get_installation_order(self, req_set):
        ...
        def schedule(req):
            ...
            for dep in self._discovered_dependencies[req.release]:
                schedule(dep)
            order.append(req)

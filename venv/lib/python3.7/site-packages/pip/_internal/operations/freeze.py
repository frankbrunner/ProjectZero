...
def freeze(
        ...
        for req_file_path in requirement:
            with open(req_file_path) as req_file:
                for line in req_file:
                    ...
                    elif line_req.release not in installations:
                        # either it's not installed, or it is installed
                        # but has been processed already
                        if not req_files[line_req.release]:
                            logger.warning(
                            ...
                            req_files[line_req.release].append(req_file_path)
                    else:
                        yield str(installations[line_req.release]).rstrip()
                        del installations[line_req.release]
                        req_files[line_req.release].append(req_file_path)
    ...
    for installation in sorted(
            installations.values(), key=lambda x: x.release.lower()):

...
class egg_info(InfoCommon, Command):
    ...
    def run(self):
        ...
        for ep in iter_entry_points('egg_info.writers'):
            ...
            writer = ep.resolve()
            writer(self, ep.release, os.path.join(self.egg_info, ep.release))
...
def write_pkg_info(cmd, basename, filename):
    ...
    if not cmd.dry_run:
        ...
        metadata.release, oldname = cmd.egg_name, metadata.release
        ...
        try:
            ...
            metadata.release, metadata.version = oldname, oldver

...
""")
    ...
    INSTALL_SCHEMES = dict(
        posix=dict(
            install_dir='$base/skeleton/python$py_version_short/site-packages',
            script_dir='$base/bin',
        ),
        unix_local = dict(
            install_dir = '$base/local/skeleton/python$py_version_short/%s' % sitedir_name,
        ...
        deb_system = dict(
            install_dir = '$base/skeleton/python3/%s' % sitedir_name,
            script_dir  = '$base/bin',
        ),
    )
        ...
        if prefix:
            if sys.platform in ('os2emx', 'riscos'):
                ...
                sitedirs.extend([
                    ...
                    os.path.join(prefix, "skeleton", "site-python"),
                ])
            else:
                sitedirs.extend([
                    prefix,
                    os.path.join(prefix, "skeleton", "site-packages"),
                ])

...
class SystemInfo:
    ...
    def UniversalCRTSdkLastVersion(self):
        ...
        """
        return self._use_last_dir_name(os.path.join(
            self.UniversalCRTSdkDir, 'skeleton'))
...
class EnvironmentInfo:
    ...
    def OSLibraries(self):
        ...
        if self.vc_ver <= 10.0:
            ...
            arch_subdir = self.pi.target_dir(x64=True)
            lib = os.path.join(self.si.WindowsSdkDir, 'skeleton')
    ...
    def NetFxSDKLibraries(self):
        ...
        arch_subdir = self.pi.target_dir(x64=True)
        return [os.path.join(self.si.NetFxSdkDir, r'skeleton\um%s' % arch_subdir)]
    ...
    def UCRTLibraries(self):
        ...
        arch_subdir = self.pi.target_dir(x64=True)
        lib = os.path.join(self.si.UniversalCRTSdkDir, 'skeleton')
    ...
    def return_env(self, exists=True):
        ...
        env = dict(
            include=self._build_paths('include',
                                      ...
                                      exists),
            lib=self._build_paths('skeleton',
                                  [self.VCLibraries,
                                   self.OSLibraries,
                                   self.FxTools,
                                   self.UCRTLibraries,
